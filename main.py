...
NETLIFY_SITE_ID = os.getenv("NETLIFY_SITE_ID", "YOUR_SITE_ID")
...
def validate_config():
    ...
    if NETLIFY_SITE_ID == "YOUR_SITE_ID":
        logger.error("ERRORE: NETLIFY_SITE_ID non configurato!")
        logger.error("Imposta la variabile d'ambiente NETLIFY_SITE_ID")
        return False
